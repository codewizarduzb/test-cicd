...
type Config struct {
	...
	AttractionServiceHost string
	AttractionServicePort int
...
func Load() Config {
	...
	c.AttractionServiceHost = cast.ToString(getOrReturnDefault("ATTRACTION_SERVICE_HOST", "127.0.0.1"))
	c.AttractionServicePort = cast.ToInt(getOrReturnDefault("ATTRACTION_SERVICE_PORT", 2222))
	//
